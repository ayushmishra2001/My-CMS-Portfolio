    ...
    <>
      ...
      <aside
        className={cn(
          ...
          "fixed md:static inset-y-0 left-0 z-50 md:z-auto md:translate-x-0",
      ...
      >
        ...
        <div className={cn("flex items-center h-16 px-4 border-b border-sidebar-border", collapsed ? "justify-center" : "justify-between")}>
          ...
          <button
            ...
            className={cn("p-1 rounded hover:bg-sidebar-accent transition-colors text-sidebar-foreground/60 hover:text-sidebar-foreground", collapsed && "hidden", "hidden md:block")}
          >
        ...
        {collapsed && (
          <button
            ...
            className="flex items-center justify-center h-8 hover:bg-sidebar-accent transition-colors text-sidebar-foreground/60 hover:text-sidebar-foreground hidden md:flex"
          >
